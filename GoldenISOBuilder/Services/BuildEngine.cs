...
public class BuildEngine
{
    ...
    private async Task GenerateUnattendAsync()
    {
        ...
        sb.AppendLine(":: Generated by WinForge");
    ...
    private static string BuildBitLockerScript(string driveLetter, string keyFolder, bool saveKey)
    {
        ...
        var script = @"# Bitlocker.ps1 — Generated by WinForge
...
<#
  Enable-BitLocker.ps1 — Generated by WinForge
...
";
    ...
    private string BuildUnattendXml()
    {
        ...
        string org       = SecurityElementEscape(
            string.IsNullOrEmpty(_s.OrgName) ? "WinForge" : _s.OrgName);
...
<footer>Generated by <strong>WinForge</strong> &middot; {generated:dddd, d MMMM yyyy} at {generated:HH:mm:ss}</footer>
<script>
(function(){{
